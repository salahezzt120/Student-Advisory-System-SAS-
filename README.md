...
## 📌 Project Overview
Many students face difficulties in course registration and academic planning, leading to scheduling conflicts and delays. The **Student Advisory System (SAS)** simplifies the process by providing a centralized platform for:
...
✅ **User Roles & Permissions** – Supports students, advisors, and administrators.  
